...
/**
  ...
  */
static MbErrorCode_t
__MbsRegDiscreteCB(MbReg_t *regs, uint8_t *pucRegBuffer, uint16_t usAddress, uint16_t usNDiscrete) {
...
MbException_t MbsFuncWrMulCoils(MbReg_t *regs, uint8_t *pPdu, uint16_t *usLen) {
 ...
 && (ucByteCountVerify == ucByteCount)) {
            ...
            eRegStatus = __MbsRegCoilsCB(regs, &pPdu[MB_PDU_FUNC_WRITE_MUL_VALUES_OFF], usRegAddress, usCoilCnt,
                                         MB_REG_WRITE);
